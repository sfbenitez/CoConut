...
def backups():
 ...
 #  else:
 sql_select="SELECT backup_host, backup_label, backup_description, backup_action, to_char(backup_date, 'YYYY-MM-DD HH24:MI:SS'), backup_check FROM BACKUPS WHERE backup_user='%s'" %(v_user)
